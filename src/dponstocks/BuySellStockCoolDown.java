...
public class BuySellStockCoolDown {
	...
	private long f(int ind, int buy, int n, int[] values, long[][] dp) {
		...
		if (buy == 1) {
			...
			long sellTake = values[ind] + f(ind + 2, 1, n, values, dp);
	...
	public static void main(String[] args) {
		int values[] = { 1, 2, 3, 0, 2 };
		BuySellStockCoolDown buySellStockCoolDown = new BuySellStockCoolDown();
		long maxProfit = buySellStockCoolDown.getMaxProfit(values);
